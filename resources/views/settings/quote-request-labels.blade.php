                    ...
                    @foreach($json_data as $k => $v)
                        <tr>
                            ...
                            <td>
                                ...
                                <input type="hidden" class="form-control" name="value[{{$k}}][filling_target_attr]" value="{{$v['filling_target_attr']}}">
                                <input type="text" class="form-control" name="value[{{$k}}][value]" value="{{$v['value']}}">
                            </td>
                        </tr>
                    @endforeach
                </table>
